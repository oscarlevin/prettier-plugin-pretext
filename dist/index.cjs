...
// src/printer.ts
var import_doc3 = __toESM(require_doc());

// src/embed.ts
var import_doc = __toESM(require_doc());
var {
  dedentToRoot,
  group,
  hardline,
...
function getParser(node, opts) {
  ...
  if (opts.plugins.some((plugin2) => typeof plugin2 !== "string" && plugin2.parsers && Object.prototype.hasOwnProperty.call(plugin2.parsers, parser2))) {
    return parser2;
  }
  return null;
}
...
var embed = (path, print, textToDoc, opts) => {
  const node = path.getValue();
...
var import_doc2 = __toESM(require_doc());
...
// src/print-children.ts
var { fill, group: group2, hardline: hardline2, indent: indent2, join: join2, line: line2, literalline: literalline2, softline: softline2 } = import_doc2.builders;
