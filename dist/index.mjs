  ...
  "node_modules/chevrotain/lib/src/generate/generate_public.js"(exports2) {
    ...
    function generateParserFactory(options) {
      ...
      return function(config) {
        return constructorWrapper(options.tokenVocabulary, config, require_api());
      };
    }
...
var require_doc = __commonJS({
  "node_modules/prettier/doc.js"(exports2, module2) {
    (function(factory) {
      ...
      var require_doc_js_umd = __commonJS2({
        "dist/_doc.js.umd.js"(exports3, module3) {
          ...
          var init_define_process = __esm2({
            "<define:process>"() {
            }
          });
          var require_doc_builders = __commonJS22({
            "src/document/doc-builders.js"(exports22, module22) {
              ...
              function dedentToRoot2(contents) {
              ...
              function conditionalGroup(states, opts) {
                return group4(states[0], Object.assign(Object.assign({}, opts), {}, {
                  expandedStates: states
                }));
              }
              function fill3(parts) {
                if (false) {
                  for (const part of parts) {
                    assertDoc(part);
                  }
              ...
              var hardline4 = concat([hardlineWithoutBreakParent, breakParent2]);
              var literalline4 = concat([literallineWithoutBreakParent, breakParent2]);
              var cursor = {
                type: "cursor",
                placeholder: Symbol("cursor")
              };
              function join4(sep, arr) {
                const res = [];
          ...
          var require_doc_utils = __commonJS22({
            "src/document/doc-utils.js"(exports22, module22) {
              ...
              function replaceTextEndOfLine(text) {
                let replacement = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : literalline4;
                return join4(replacement, text.split("\n")).parts;
              }
...
function replaceNewlines(doc) {
  return import_doc.utils.mapDoc(doc, (currentDoc) => typeof currentDoc === "string" && currentDoc.includes("\n") ? currentDoc.split(/(\n)/g).map((v, i) => i % 2 === 0 ? v : literalline) : currentDoc);
}
...
function getParser(node, opts) {
  ...
  const parser2 = Name[0].image.toLowerCase();
  if (parser2 === "ptx") {
    return null;
  }
  if (parser2 === "style" && attribute && attribute.some((attr) => attr.children.Name[0].image === "type" && attr.children.STRING[0].image === '"text/css"')) {
    return "css";
  }
  if (opts.plugins.some((plugin) => typeof plugin !== "string" && plugin.parsers && Object.prototype.hasOwnProperty.call(plugin.parsers, parser2))) {
    return parser2;
  }
  return null;
}
...
var import_doc, dedentToRoot, group, hardline, indent, join, line, literalline, softline, embed, embed_default;
var init_embed = __esm({
  "src/embed.ts"() {
    "use strict";
    import_doc = __toESM(require_doc());
    ({
      dedentToRoot,
      group,
      hardline,
    ...
    embed = (path, print, textToDoc, opts) => {
      const node = path.getValue();
      ...
      return group([
        openTag,
        literalline,
        dedentToRoot(replaceNewlines(import_doc.utils.stripTrailingHardline(textToDoc(getSource(content), { ...opts, parser: parser2 })))),
        hardline,
        closeTag
      ]);
    };
...
function printChildrenWhenWhitespaceDoesNotMatter(path, print) {
  ...
  const fragments = nodePath.call((childrenPath) => {
    ...
    if (children.PROCESSING_INSTRUCTION) {
      response.push(...childrenPath.map(printIToken, "PROCESSING_INSTRUCTION"));
    }
    return response;
...
var import_doc2, fill, group2, hardline2, indent2, join2, line2, literalline2, softline2;
var init_print_children = __esm({
  "src/print-children.ts"() {
    "use strict";
    import_doc2 = __toESM(require_doc());
    init_print_utils();
    ({ fill, group: group2, hardline: hardline2, indent: indent2, join: join2, line: line2, literalline: literalline2, softline: softline2 } = import_doc2.builders);
  }
});
...
function indentablePreToLines(rawText, tabWidth = 4) {
  ...
  lines = lines.map((line4) => {
    const trimPos = getNumCharsForWhitespaceLen(line4, charsTrimmable, tabWidth);
...
var import_doc3, fill2, group3, hardline3, indent3, join3, line3, literalline3, softline3, breakParent, ignoreStartComment, ignoreEndComment, printer, printer_default;
var init_printer = __esm({
  "src/printer.ts"() {
    "use strict";
    import_doc3 = __toESM(require_doc());
    init_embed();
    init_print_children();
    init_print_utils();
    init_special_nodes();
      ...
      print(path, opts, print) {
        ...
        switch (node.name) {
          ...
          case "document": {
            ...
            fragments.sort((left, right) => left.offset - right.offset);
            const ret = [
              join3(hardline3, fragments.map(({ printed }) => printed)),
              hardline3
            ];
            return ret;
          }
          case "element": {
            ...
            if (attribute) {
              ...
              parts.push(indent3([
                line3,
                join3(separator, path.map(print, "children", "attribute"))
              ]));
            }
            const space = line3;
            if (SLASH_CLOSE) {
            ...
            if (INDENTABLE_PRE_ELEMENTS.has(tagName)) {
              ...
              const verbDoc = join3(hardline3, indentablePreToLines(originalText, opts.tabWidth));
              return group3([
                openTag,
            ...
            if (isWhitespaceIgnorable(content[0])) {
              ...
              const fragments = printChildrenWhenWhitespaceDoesNotMatter(path, print);
              ...
              const docsAndFrags = fragments.flatMap((node2, i) => {
              ...
              const docs = docsAndFragsWithLines.map((item) => isFragment(item) ? item.printed : item);
              if (inParMode) {
                return group3([
                  openTag,
                  indent3([softline3, fill2(docs)]),
                  softline3,
                  closeTag
                ]);
              }
          ...
          case "prolog": {
            ...
            if (attribute) {
              parts.push(indent3([
                softline3,
                join3(line3, path.map(print, "children", "attribute"))
              ]));
            }
